<?
	...
	$mcImageManagerConfig['filesystem.include_file_pattern'] = '/\.jpg$|\.gif$|\.png$|\.bmp$|\.txt$|\.pdf|\.doc$|\.docx$$/i';
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,txt,pdf,doc,docx";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,txt,pdf,doc,docx";
	$mcImageManagerConfig['upload.invalid_extension_msg'] = "Error: Invalid extension: Valid extensions are: gif,jpg,png,bmp,txt,pdf,doc,docx.";
