			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat  col-lg-6">
					<div class="panel-heading">
						<h5 class="panel-title">List Of Status Code</h5>
					</div>
					...
					<div class="panel-body">
						<table class="table table-striped table-bordered sp-a-40"
							...
							<thead>
								<tr>
									<th>Status Code Title</th>
									<th>Status Code</th>
									<th>Actions</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${statusCode}" var="sc">
									<tr>
										<td>${sc.statusCodeTitle}</td>
										<td>${sc.statusCode}</td>
										<td><form:form servletRelativeAction="/editStatusCode"
												method="POST">
												<input type="hidden" name="statusCodeId" value="${sc.statusCodeId}" />
												<button type="submit" class="btn btn-primary btn-xs"
													style="padding-left: 12px; padding-right: 13px;">
													Edit <span class="glyphicon glyphicon-edit"></span>
												</button>
											</form:form>&nbsp; <a href="deletestatusCode?statusCodeId=${sc.statusCodeId}"
											title="Delete"
