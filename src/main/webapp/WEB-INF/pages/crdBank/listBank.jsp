			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat  col-lg-6">
					<div class="panel-heading">
						<h5 class="panel-title">List Of Bank</h5>
					</div>
							...
							<tbody>
								<c:forEach items="${banks}" var="b">
									<tr>
										<td>${b.bankName}</td>
										<td>${b.bankCode}</td>
										<td><form:form servletRelativeAction="/editBank"
												method="POST">
												<input type="hidden" name="bankId" value="${b.bankId}" />
												<button type="submit" class="btn btn-primary btn-xs"
													style="padding-left: 12px; padding-right: 13px;">
													Edit <span class="glyphicon glyphicon-edit"></span>
												</button>
											</form:form>&nbsp; <a href="deleteBank?bankId=${b.bankId}"
											title="Delete"
