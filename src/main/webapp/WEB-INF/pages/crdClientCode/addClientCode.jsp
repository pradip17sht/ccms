			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat  col-lg-6">
					<div class="panel-heading">
						<h5 class="panel-title">Add Client Code</h5>
					</div>
						...
						<form:form class="form-horizontal" method="POST"
							...
							<fieldset class="content-group">
								<form:radiobutton path="clientcodeType" value="Manual"
									id="manual" checked="checked" />
								Manual <BR>
								<div id="digits" style="display: none;">
									<div class="col-lg-12">
										<form:input path="clientcodeDigits" type="number"
											class="form-control" placeholder="Enter Digits"
											required="required" />
									</div>
								</div>
