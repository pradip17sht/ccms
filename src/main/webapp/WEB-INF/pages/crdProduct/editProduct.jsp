				...
				<div class="panel panel-flat  col-lg-6">
					...
					<div class="panel-body">
						<form:form class="form-horizontal" method="POST"
							action="updateProduct" modelAttribute="products">
							<form:hidden path="productId" />
							<fieldset class="content-group">
								<div class="form-group">
									<label class="control-label col-lg-3">Product Name:<span
								...
								<div class="form-group">
									<label class="control-label col-lg-3">Product Code:<span
										style="color: red;">*</span></label>
									<div class="col-lg-9">
										<form:input path="productCode" type="text"
											class="form-control" maxlength="3"
											placeholder="Product code max-3 digit" required="required" />
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<select id="currency" name="currency" class="form-control"
											required="required">
											<c:choose>
												<c:when test="${products.currency eq '524'}">
													<option value="524" selected="selected">NPR</option>
													<option value="840">USD</option>
												</c:when>
												<c:when test="${products.currency eq '840'}">
