			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat  col-lg-6">
					<div class="panel-heading">
						<h5 class="panel-title">List Of Department</h5>
					</div>
							...
							<tbody>
								<c:forEach items="${departments}" var="d">
										...
										<tr>
											...
											<td>
											<c:forEach items="${branches}" var="b"><c:if test="${d.branchCode eq b.branchCode}">
											${b.branchName}
										</c:if></c:forEach></td>
											<td><form:form servletRelativeAction="/editDepartment"
													method="POST">
